...
public class RideShareServiceImpl implements RideShareService {
    ...
    @Override
    public void startRideShareEventProduction() {
        ...
        executor = Executors.newFixedThreadPool(number_of_producers,r ->
                new Thread(r, "ride-event-producer")
        );
    ...
    private void produceOneRideLifecycle() {
        ...
        for (RideEvent type : RideEvent.values()) {
            ...
            RidesEvent event = new RidesEvent(
                    rideId.toString(),
                    city,
                    type.toString(),
